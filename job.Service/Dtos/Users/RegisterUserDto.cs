    ...
    public class RegisterUserDtoValidator : AbstractValidator<RegisterUserDto>
    {
        public RegisterUserDtoValidator()
        {
            ...
            RuleFor(x => x.Password).NotEmpty().MinimumLength(6).MaximumLength(128)
                ...
                .WithName("密码");
            RuleFor(x => x.Email).NotEmpty().MaximumLength(128).EmailAddress().Matches(@"^[A-Za-z0-9\u4e00-\u9fa5]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$").WithName("电子邮箱");
            ...
            RuleFor(x => x.Other).MaximumLength(500).WithName("其他");
        }
    }
}
